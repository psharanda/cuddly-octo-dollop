...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SCSDKCameraKit",
            url: "https://github.com/psharanda/cuddly-octo-dollop/releases/download/1.34.0/SCSDKCameraKit.xcframework.zip",
            checksum: "c78e41dfc0ece785f262fc6813bc86f6b6258371842a49002fe5f977ff47188b"
        ),
        .binaryTarget(
            name: "SCSDKCameraKitBaseExtension",
            url: "https://github.com/psharanda/cuddly-octo-dollop/releases/download/1.34.0/SCSDKCameraKitBaseExtension.xcframework.zip",
            checksum: "e50b178345d89e87cdf7901df62265fa1d0cefbdc744121a979862a62d926ff3"
        ),
        .binaryTarget(
            name: "SCSDKCameraKitLoginKitAuth",
            url: "https://github.com/psharanda/cuddly-octo-dollop/releases/download/1.34.0/SCSDKCameraKitLoginKitAuth.xcframework.zip",
            checksum: "924e10fd37e9407638020451be91ae275dad89a1482b05c1aac0496abe73fe41"
        ),
        .binaryTarget(
            name: "SCSDKCameraKitPushToDeviceExtension",
            url: "https://github.com/psharanda/cuddly-octo-dollop/releases/download/1.34.0/SCSDKCameraKitPushToDeviceExtension.xcframework.zip",
